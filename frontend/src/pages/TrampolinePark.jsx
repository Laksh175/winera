        ...
        <div className="winera-trampoline-intro-grid" style={{
          ...
          <div className="winera-trampoline-intro-text" style={{ textAlign: 'left' }}>
            ...
            <div className="winera-cyan-cta-wrapper winera-cyan-cta-wrapper-sm">
              <a
                href={siteData?.trampolineIntro?.buttonLink || siteData?.trampolineIntro?.ctaLink || "https://wa.me/919428989488"}
                target="_blank"
                rel="noreferrer"
      ...
      <section className="winera-trampoline-specs-section" style={{ padding: '30px 4vw 75px', background: '#F5F5F9', overflow: 'hidden' }}>
        <div style={{ maxWidth: '1240px', margin: '0 auto' }}>
          ...
          <div className="winera-trampoline-specs-card" style={{
            ...
            width: '100%',
            minHeight: '540px',
            background: `url(${trampolineImg3}) center center / 100% 100% no-repeat`,
            borderRadius: '32px',
            padding: '45px 50px',
            display: 'flex',
            flexDirection: 'column',
        ...
        <div style={{ maxWidth: '1240px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <div className="winera-cyan-cta-wrapper winera-cyan-cta-wrapper-sm">
                <a
                  href={siteData?.trampolineRoi?.buttonLink || "https://wa.me/919428989488"}
                  target="_blank"
                  rel="noreferrer"
                  className="winera-cyan-cta-btn winera-cyan-cta-btn-sm"
