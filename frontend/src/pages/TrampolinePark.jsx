          ...
          <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 4vw' }}>
            ...
            <div className="winera-trampoline-inside-header" style={{ textAlign: 'center', maxWidth: '840px', margin: '0 auto 35px', position: 'relative' }}>
              <div style={{ display: 'inline-block', position: 'relative' }}>
                ...
                />
                <h2 style={{ fontSize: '35px', fontWeight: '900', color: '#091E2B', lineHeight: 1.2, margin: '0 0 14px 0', letterSpacing: '-0.02em' }}>
                  {(() => {
          ...
          <div style={{
            ...
            <div style={{ position: 'relative', zIndex: 2 }}>
              ...
              <p style={{
                ...
                <br />
                <span style={{ color: '#ffffff', opacity: 1 }}>{siteData?.trampolineCta?.descLine2 || "recommend the right zone mix for your space."}</span>
              </p>
