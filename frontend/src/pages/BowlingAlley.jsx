        ...
        <div style={{
          ...
          <div className="winera-bowling-types-grid" style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '30px', alignItems: 'center' }}>
            ...
            <div className="winera-bowling-types-text" style={{ paddingLeft: '15px', paddingRight: '15px' }}>
              ...
              <p style={{ fontSize: '13.5px', color: '#475569', lineHeight: 1.65, fontWeight: '500', marginBottom: '14px' }}>
              ...
              <p style={{ fontSize: '13.5px', color: '#475569', lineHeight: 1.65, fontWeight: '500', marginBottom: '24px' }}>
              ...
              <div className="winera-bowling-types-btn-row" style={{ display: 'flex', gap: '16px', alignItems: 'center', flexWrap: 'wrap' }}>
                <div style={{ position: 'relative', display: 'inline-block' }}>
                  <div style={{
                    position: 'absolute',
                    top: '-3px',
                ...
                <a
                  ...
                  rel="noreferrer"
                  download
                  aria-label="Download Free Fall Bowling Brochure"
                  style={{
                    background: '#38bdf8',
                    color: '#ffffff',
                    fontSize: '13.5px',
            ...
            <div className="winera-bowling-types-pills-col" style={{ position: 'relative', width: '100%', height: '500px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <span style={{ color: '#ffffff', fontWeight: '800', fontSize: '12px', whiteSpace: 'nowrap' }}>
                ...
                <div style={{
                  ...
                  <span style={{ color: '#ffffff', fontWeight: '800', fontSize: '11.5px', whiteSpace: 'nowrap' }}>
                ...
                <div style={{
                  ...
                  <span style={{ color: '#ffffff', fontWeight: '800', fontSize: '11.5px', lineHeight: 1.25, whiteSpace: 'pre-line' }}>
          ...
          <div className="winera-bowling-types-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: '30px', alignItems: 'center' }}>
            ...
            <div className="winera-bowling-types-pills-col" style={{ position: 'relative', width: '100%', height: '500px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <span style={{ color: '#0f172a', fontWeight: '800', fontSize: '11.5px', lineHeight: 1.25, whiteSpace: 'pre-line' }}>
                ...
                <div style={{
                  ...
                  <span style={{ color: '#0f172a', fontWeight: '800', fontSize: '12px', whiteSpace: 'nowrap' }}>
            ...
            <div className="winera-bowling-types-text">
              <div style={{ position: 'relative', display: 'block', marginBottom: '14px' }}>
                ...
                />
                <h3 style={{ fontSize: '2.4rem', fontWeight: '900', color: '#0f172a', lineHeight: 1.15, margin: 0 }}>
                  String Bowling Machines: <span style={{ color: '#38bdf8' }}>Affordable Bowling Setup for Every Venue</span>
                </h3>
              </div>
      ...
      <section className="winera-bowling-roi-section" style={{ padding: '45px 4vw', background: '#F5F5F9' }}>
        <div className="winera-bowling-roi-grid" style={{
          ...
          <div className="winera-bowling-roi-text" style={{ padding: '50px 55px', display: 'flex', flexDirection: 'column', justifyContent: 'center', textAlign: 'left' }}>
            ...
            <div>
              <div style={{ position: 'relative', display: 'inline-block' }}>
                {/* Rotated Cyan Backdrop Box (Image 2 style) */}
                <div style={{
                  position: 'absolute',
                  top: '-3px',
                  bottom: '-3px',
